...
const EditAgreement = ({ params }: { params: { id: string } }) => {
      ...
      try {
        ...
        if (result.data && result.data.length > 0) {
          ...
          setFormData({
            ...
            franchisor: agreement.franchisor || "",
            initial_fee: agreement.initial_fee || "",
            contract_duration: agreement.contract_duration || "",
            franchisor_share: agreement.franchisor_share || "",
  ...
  const handleSubmit = async () => {
    ...
    try {
      const response = await fetch("/api/update-agreement", {
        method: "PUT",
        headers: { "Content-Type": "application/json" },
      ...
      const result = await response.json()
      if (!response.ok) {
        throw new Error(result.error || "Failed to update agreement. Please try again.")
      }
  ...
  if (loading) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-b from-black to-gray-900">
        <div className="text-white text-lg">Loading agreement...</div>
      </div>
    )
  }
    ...
    <div className="min-h-screen mt-14 bg-gradient-to-b from-black to-gray-900 text-white py-16 px-4">
      <div className="max-w-3xl mx-auto">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-400 mt-2">Update the terms of your blockchain-based agreement</p>
        </div>
          ...
          <CardHeader className="border-b border-gray-700">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <CardDescription>
                  {step === 1
                    ? "Update the basic information about your agreement"
                    : step === 2
                      ? "Modify the legal terms and conditions"
                      : step === 3
                        ? "Adjust the contract duration and initial parameters"
                        : "Update financial terms and dispute resolution"}
                </CardDescription>
              </div>
            </div>
          </CardHeader>
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex items-center gap-2 px-3 py-2 bg-gray-900 border border-gray-700 rounded-md">
                    ...
                    <span className="text-sm text-gray-300 truncate">
                      {formData.franchisor || (wallet.publicKey ? wallet.publicKey.toString() : "Connect your wallet")}
                    </span>
                  </div>
              ...
              <div className="space-y-4">
                ...
                <div className="mt-6 p-4 bg-green-900/20 border border-green-800 rounded-lg">
                  ...
                  <p className="text-sm text-gray-300 mt-2">
                    By updating this agreement, you are modifying the terms. If this agreement has already been accepted
                    by another party, the changes will need to be approved again.
                  </p>
                </div>
              </div>
            )}
